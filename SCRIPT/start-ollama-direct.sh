...
OLLAMA_HOST=0.0.0.0 OLLAMA_PORT=11434 nohup apptainer run --nv --bind "${PROJET_ROOT}/apptainer_data/ollama_data:/root/.ollama" "${PROJET_ROOT}/UQAR/ollama.sif" > ${PROJET_ROOT}/apptainer_data/logs/ollama.log 2>&1 &
